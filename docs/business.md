...
| 商品 | 形態 | 価格(ペアで1つ) | 提供開始 |
| :-- | :-- | :-- | :-- |
| サボリーヌ・プレミアム | 月ごとの自動更新 | 680円 / 月 | ベータの判定を通過した翌月 |
| サボリーヌ・プレミアム | 年ごとの自動更新 | 4,800円 / 年(月あたり400円) | 同上 |
| 1年のふたりの物語 | 一度きりの購入 | 4,800円 | 提供開始から1年後 |
...
支払いの受け口は、Web版で先に開く。App Store のアプリ内課金は、iPhone版を出したあとに並べて足す。

理由は3つある。

第一に、**待たなくてよい**。Web版はすでに動いており、iPhoneでもホーム画面に追加すればアプリとして使える。App Store を待つと、払いたい人がいても受け取る手段が半年ないままになる。払う人が現れるかどうかは、この事業でいちばん確かめたいことのひとつであり、確かめる時期を自分から遅らせる理由がない。

第二に、**手取りが大きい**。Web版で受け取る場合の手数料は、決済で3.6%、継続課金の管理で0.7%の計4.3%である。App Store のアプリ内課金は15%(Apple Small Business Program、前年の受取額が100万ドル未満の開発者が対象)。年額プラン1件あたりの手取りは、Web版が4,594円、App Store が4,080円となる。

第三に、**審査に事業を預けなくてよい**。App Store の審査は、通る前提で予定を組むと外れたときに丸ごと止まる。Web版の受け口が先にあれば、審査は「増やす話」であって「前に進める条件」ではなくなる。

App Store のアプリ内課金をやめるわけではない。iPhone版のアプリの中で払いたい人には、それが最も自然な手段である。ただし iPhone版のアプリからWeb版の支払いへ誘導することは Apple の規約で認められないため、アプリの中では素直にアプリ内課金だけを置く。

**この方針にはオーナーの決裁が要る。**Web版で受け取るには決済事業者(Stripe)との契約が必要であり、契約と入金口座の登録は本人でなければできない。

「1年のふたりの物語」は、1年ぶんの記録をふたりの物語として1本のムービーと1冊の本に仕立てる、記念日向けの単発商品である。利益率は低いが、それ自体がSNSで共有される素材になり、宣伝費をかけない事業の宣伝装置として働く。1年ぶんの記録が貯まってから始める。
...
受け取りの手数料は、Web版が4.3%(決済3.6% + 継続課金の管理0.7%)、App Store のアプリ内課金が15%である。年額プラン1件あたりの手取りは、Web版が4,594円、App Store が4,080円となる。以降の計算は、先に開くWeb版の4,594円で置く。
...
年間の実費4.0万円を、継続的な収入が上回る状態。**年額プランの課金ペアが9組**で到達する。

ここは事業の存続条件であり、達成できるかどうかを議論する段階ではなく、受け口を開いてまもなく通過すべき地点として扱う。数百組が使っていれば、課金率が数パーセントでも届く水準である。
...
| 前提 | 値 |
| :-- | :-- |
| 1ペアあたりの年間手取り(年額プラン・Web版) | 4,594円 |
| 必要な課金ペア数 | 600万円 ÷ 4,594円 ≒ **1,306組** |
| 課金率(継続して使っているペアのうち払うペアの割合) | 5%を目標とする |
| 必要な継続ペア数 | 1,306 ÷ 5% ≒ **26,120組(約52,000人)** |

課金率5%の置き方を説明する。無料でも中核が完全に使えるアプリ(フリーミアム)の課金転換率は、業界の中央値で2.1%とされる。saborine はこれを上回る前提を置く。理由は、支払いがペア単位で心理的な単価が半分になること、そして商品が「積み上がった思い出」であり、続けているペアほど手放しにくくなるためである。ただしこれは仮説であり、課金導入後の実測で置き換える。課金率が3%に留まる場合、必要な継続ペア数は43,500組(約87,000人)となる。
...
| :-- | :-- | :-- | :-- |
| 使いはじめる | 紹介ページに着いた人のうち、表示名の登録を終えた割合 | 40% | 紹介ページの伝わり方、登録の重さ、最初の1分の体験 |
...
| 2026年8月下旬〜9月 | SNSアカウントの開設と、週4本の投稿を開始(リンクの行き先は公開済みの紹介ページ) | 開設30日で仮説5の判定材料が揃う |
| 2026年9月 | Web版でプレミアムの提供開始 | 段階1(実費の黒字化)を通過 |
| 2026年9月〜10月 | ホーム画面ウィジェット(V1.1)とiOSネイティブ版 | 「都度開くのが面倒」への回答が実機で動く |
| 2026年10月〜11月 | App Store への申請と公開、アプリ内課金の追加 | 審査通過 |
...
| 一般公開から3ヶ月、ペア成立率が30%未満 | 招待体験の作り直しを最優先とする。他の開発を止める |
| 一般公開から6ヶ月、4週継続率が15%未満 | キャラクターの表現力(Rive導入)とウィジェットに投資を集中する。それでも動かなければ、飽きへの根本的な打ち手がないと判断する |
| プレミアム提供から6ヶ月、課金率が1%未満 | 商品の中身を入れ替える。価格を下げるのではなく、売るものを見直す |
| 一般公開から12ヶ月、段階1(実費の黒字化)に未到達 | 事業としての継続可否をオーナーが判断する |
